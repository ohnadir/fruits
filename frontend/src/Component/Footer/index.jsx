    ...
    return(
        <div className=' bg-white footer-container'>
            <div className='max-w-7xl mx-auto px-10 py-16'>
                <div className='footer-body grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3 '>
                    ...
                    <div className='sm:mx-auto w-fit'>
                        ...
                        <div className='input-container relative'>
                            ...
                            <input type="text" className='border ' placeholder='Write your email here' />
                            <button className='absolute right-[45px] top-[13%]'>
