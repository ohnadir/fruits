            ...
            <div className='login'>
                <div className='flex justify-center items-center h-[91.5vh]'>
                    <div className='login-container bg-white'>
                        <div className='py-5'>
                            <div className='mb-8'>
                                <h1 className='text-[30px] font-bold text-center px-10 m-0'>Signing Up</h1>
                            ...
                            <div className='grid grid-cols-1 gap-5 px-10'>
                                ...
                                <button className='login-btn' onClick={onSubmit}>Register</button>
                            </div>
                            ...
                            <div className='text-[15px] text-center mt-3'>
                                <span className='text-[#6b7280] '>Already have an account ? <span className='text-black font-bold'>Login</span></span>
                            </div>
                        </div>
                    </div>
                </div> 
